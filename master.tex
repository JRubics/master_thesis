...
Zadatak ovog rada je da kroz realan primer razvoja softvera otvorenog koda (eng.\ \textit{open-source}) testira primer upotrebe Github akcija i sve prednosti i mane koje ovaj alat donosi. Projekat otvorenog koda koji se koristi u ovom primeru je \textit{pjisp-assignment-template}. To je softverski alat koji se koristi za automatizovano kreiranja zadataka za studente na predmetu Programski jezici i strukture podataka na Fakultetu tehničkih nauka u Novom Sadu.
...
Ovaj rad opisuje sve prethodno pomenute alate, tehnologije koje se koriste za njihovu implementaciju i način njihove integracije u celinu upotrebom GitHub akcija. Na kraju smog rada, izvedeni su zaključci o GitHub akcijama stečeni na osnovu njihovog korišćenja u procesu izrade ovog rada.
